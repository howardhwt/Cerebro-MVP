    ...
    <div className="flex h-screen flex-col bg-base text-slate-100 overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-64 rounded-lg border border-slate-800 bg-base-100 pl-10 pr-4 py-2 text-sm text-slate-200 placeholder-slate-500 focus:border-accent/50 focus:outline-none focus:shadow-glow-sm transition-all"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 bg-base bg-grid flex flex-col overflow-hidden">
          {/* Page Header */}
          <div className="border-b border-slate-800/50 bg-base-50/80 backdrop-blur-sm px-6 py-4">
                      ...
                      {filteredAndSortedCompanies.map((company) => (
                        ...
                        >
                          ...
                          <td className="px-5 py-4 text-right">
                            <Link
                              href={`/companies/${company.id}`}
                              className="inline-flex items-center gap-1 text-xs text-slate-400 hover:text-accent-light transition-colors opacity-0 group-hover:opacity-100"
                            >
                              View
